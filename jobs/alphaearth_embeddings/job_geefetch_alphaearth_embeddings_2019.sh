...
DATA_DIR=/lustre/fsn1/projects/rech/ego/uyr48jk/alphaearth_embeddings/2019
CONFIG_PATH=/linkhome/rech/gennjv01/uyr48jk/work/geefetch_configs/alphaearth_embeddings/config_alphaearth_embeddings_2019.yaml
