...
## Usage
1. Draft or update an outline YAML document that conforms to `article/scripts/schemas/outline.schema.json`.
...
See `article/scripts/prompts/codex_linearize.txt` for automated conversions between outline YAML and manuscript drafts.
