...
3. Store the graph as YAML or JSON that validates against `article/scripts/schemas/spg.schema.json`.
...
See `article/scripts/prompts/codex_graph.txt` for automated procedures that generate or validate SPG files from the codebase.
