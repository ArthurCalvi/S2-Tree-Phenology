...
mkdir /lustre/fsn1/projects/rech/ego/uyr48jk/mosaic_corsica_2023/20230515

# Run geefetch
geefetch all -c /linkhome/rech/gennjv01/uyr48jk/work/S2-Tree-Phenology/ops/geefetch/configs/config_corsica_20230515.yaml
